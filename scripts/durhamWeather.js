...
// disables buttons when loading (avoids multiple presses while waiting on a response)
...
function getTemperature() {
    // function call disables button and shows spinner while waiting on fetch
    showSpinner()
    ...
    // buttons are unfrozen when temperature is displayed
...
function getConditions() {
    ...
    // buttons are unfrozen when weather condition is displayed
    .finally(() => setButtonsDisabled(false))
}
